...
```text
http://rmzn.net:8000/mock/payments/<internal_invoice_id>/pay
```
...
- `Админ: доступ 7 дней`, `Админ: доступ 30 дней`, `Админ: доступ 90 дней` - ручная выдача доступа себе для проверки.
